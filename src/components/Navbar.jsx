    ...
    return (
        <nav className='w-full pt-6 pb-5 flex justify-between items-center'>
            ...
            <div className="flex items-center *:not-focus:outline-none *:font-semibold *:cursor-pointer space-x-3">
                <button type="button" aria-label="Add transaction" className={`sm:bg-blue-500 sm:hover:bg-blue-600 sm:text-white border ${borderColor} sm:border-none p-2 rounded-full sm:rounded-lg flex items-center gap-1 transition-colors duration-150`} onClick={() => navigate("/home/add-transaction")}>
                    <IoAdd className="text-xl font-bold shrink-0" />
